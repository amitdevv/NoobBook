...
This utility provides a single source of truth for all
...
def get_data_dir() -> Path:
    ...
    This is the root for all persistent data.
...
def get_projects_base_dir() -> Path:
    ...
    This holds individual project directories.
    Auto-creates if it doesn't exist.
    """
...
def get_prompts_dir() -> Path:
    ...
    Contains JSON files with prompt configurations
...
def get_project_file(project_id: str) -> Path:
    ...
    Project metadata lives in Supabase, but custom prompt
...
def get_raw_dir(project_id: str) -> Path:
    ...
    Original uploaded files are stored here.
...
def get_processed_dir(project_id: str) -> Path:
    ...
    Extracted text from PDFs, images, audio, etc.
...
def get_chunks_dir(project_id: str) -> Path:
    ...
    For large sources that need embedding,
...
def get_chats_dir(project_id: str) -> Path:
    ...
    Chat data is stored in Supabase (chats and messages tables).
...
def get_ai_images_dir(project_id: str) -> Path:
    ...
    Stores plots, charts, and visualizations
...
def get_studio_dir(project_id: str) -> Path:
    ...
    Stores all studio-generated content
...
def get_agents_dir(project_id: str) -> Path:
    ...
    Stores execution logs for agent runs
...
def ensure_base_directories() -> None:
    ...
    Call this on app startup to create the
